...
import { TrendingUp, MessageSquare, Hash, BarChart3 } from 'lucide-react'
...
function SentimentChartContent({ 
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {viewType === 'trend' && (
        <div className="bg-white p-6 rounded-lg border">
          <h4 className="text-md font-medium text-gray-800 mb-4">감정 트렌드 (최근 7일)</h4>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="mt-4 text-center text-sm text-gray-600">
            * 시계열 감정 분석 데이터는 추후 구현 예정 (긍정-부정 차이 기반 점수)
          </div>
        </div>
      )}
